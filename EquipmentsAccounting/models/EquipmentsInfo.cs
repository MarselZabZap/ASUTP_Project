...
namespace EquipmentsAccounting.models
{
    internal class EquipmentsInfo
    {
        ...
        /*public EquipmentsInfo(int locId, int genId, string type, string characteristics, string nomenNum, string subschet, string provider, string datePurchase, string warrancy, int price, string serialNum) 
        {
            this.LocId = locId;
            this.GenId = genId;
            this.Type = type;
